...
gsap.set(".stackly-about", { opacity: 0 });
gsap.set(".about-img-wrapper", { opacity: 0, y: -10 });
gsap.set(".about-badge", { scale: 0.7, opacity: 0 });
gsap.set(".about-label", { opacity: 0, y: 50 });
gsap.set(".about-title", { opacity: 0, y: 50 });
gsap.set(".about-desc", { opacity: 0, y: 50 });
gsap.set(".about-features", { opacity: 0, y: 50 });
gsap.set(".about-btn", { opacity: 0, y: 50 });
